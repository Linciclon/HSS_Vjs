...
#define OPEN_M_ACCESS_HSS_PMP1_SCRATCH_EG0          0x2807FFFULL   /* 256K SCRATCHPAD */
#define OPEN_M_ACCESS_HSS_PMP1_SCRATCH_EG1          0x280FFFFULL   /* 512K SCRATCHPAD */
...
#define  SCRATCH_512K_FROM_BASE                    0x280FFFFULL   /* 512K LIM */
        ...
        *pmp0cfg |= 0x9F009F9FULL;  /* open 0,1 and 3 to allow open access */
        write_csr(pmpaddr0, OPEN_M_ACCESS_HSS_PMP1_LIM_EG0); //joao was eg1
        write_csr(pmpaddr1, OPEN_M_ACCESS_HSS_PMP1_SCRATCH_EG0); //JOAO was EG1
